...
{
    public class View1VM : INotifyPropertyChanged
    {
        ...
        public View1VM(IUnityContainer unityContainer)
        {
        ...
        {
            _eventAggregator.GetEvent<ActivateView>().Publish(new ViewActivation { NavigateFrom = "View1", NavigateTo = "OtherView" });

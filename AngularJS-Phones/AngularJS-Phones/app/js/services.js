...
angular.module('PhoneApp.services', ['ngResource']).
    factory('PhoneService', function () {        
        var phones = [
            ...
            { id: "4", name: "Droid Pro by Motorola", img: "../app/img/droid-pro-by-motorola.jpg", description: "Access your work directory, email or calendar with DROID Pro by Motorola., an Android-for-business smartphone with corporate-level security. It features both a QWERTY keyboard and touchscreen, a speedy 1 GHz processor and Adobe\u00ae Flash\u00ae Player 10." },
            { id: "5", name: "Motorola Atrix 4G", img: "../app/img/motorola-atrix-4g.jpg", description: "MOTOROLA ATRIX 4G gives you dual-core processing power and the revolutionary webtop application. With webtop and a compatible Motorola docking station, sold separately, you can surf the Internet with a full Firefox browser, create and edit docs, or access multimedia on a large screen almost anywhere." },
            { id: "6", name: "Motorola Bravo with Motoblur", img: "../app/img/motorola-bravo-with-motoblur.jpg", description: "MOTOROLA BRAVO\u2122 with MOTOBLUR\u2122 with its large 3.7-inch touchscreen and web-browsing capabilities is sure to make an impression.  And it keeps your life updated and secure through MOTOBLUR." }
        ];
        var reviews = [
